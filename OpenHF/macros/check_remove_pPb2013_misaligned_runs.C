// to check if any of the to-be removed file contains events that should not be removed. 
#include <stdio.h>
#include <fstream>
#include <iostream>
#include "TFile.h"
...
void check_remove_pPb2013_misaligned_runs(int startFile, int endFile, char *filelist)
{
    char* filename = new char[1000];
    sprintf(filename, "check_%s_%dTo%d.lis",  filelist, startFile, endFile);
