...
OpenHfTree = cms.EDAnalyzer(
        ...
        #nameOfMapRunLumiFile = cms.untracked.string("mapRunLumiHfTreeFile_highPt_pp.root"),
        #pathOfhftree = cms.untracked.string("root://xrootd.rcac.purdue.edu//store/user/wxie/HeavyFlavor_highPt_pp"), 
	#
