...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                ...
                                "/store/hidata/HIRun2013/PAHighPt/RECO/PromptReco-v1/000/211/631/00000/00EB24F5-FB74-E211-8014-E0CB4E553651.root"
                            ))
...
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu3CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs3CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs3PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu3PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak3PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak3CaloJetSequence_pPb_data_bTag_cff')

process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu4CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs4CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs4PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu4PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak4PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak4CaloJetSequence_pPb_data_bTag_cff')

process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu5CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs5CaloJetSequence_pPb_data_bTag_cff')
#process.load('HeavyIonsAnalysis.JetAnalysis.jets.akVs5PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.akPu5PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak5PFJetSequence_pPb_data_bTag_cff')
process.load('HeavyIonsAnalysis.JetAnalysis.jets.ak5CaloJetSequence_pPb_data_bTag_cff')
...
process.jetSequences = cms.Sequence(process.voronoiBackgroundCalo +
                                    ...
                                    process.PFTowers +
                                    process.hiReRecoCaloJets_reduced +
                                    process.hiReRecoPFJets_reduced +
...
process.load('HeavyIonsAnalysis.EventAnalysis.hltanalysis_PA_cff')
...
process.OpenHfTree_step.remove(process.dsKstarKaDump)
